...
public enum KanaCatalog {
    ...
    public static let all: [KanaCard] = {
        ...
        let table: [(Int, Int, String, String, String, String, String, String, Bool)] = [
            ...
            (0, 3, "え", "エ", "e", "えんぴつ", "エプロン", "pencil", false),
            (0, 4, "お", "オ", "o", "おにぎり", "オルガン", "riceball", false),
            ...
            (4, 4, "の", "ノ", "no", "のり", "ノート", "seaweed", false),
            ...
            (6, 0, "ま", "マ", "ma", "まくら", "マスク", "pillow", false),
            ...
            (8, 3, "れ", "レ", "re", "れいぞうこ", "レモン", "fridge", false),
